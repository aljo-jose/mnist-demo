...
def main():
    ...
    parser.add_argument('--model', type=str, metavar='N',
                        help='fc/cnn/student', default='fc', required=False)
    parser.add_argument('--experiment', type=str, metavar='N',
                        help='experiment name', default='demo', required=False)
    ...
    assert args.model in ('fc', 'cnn', 'student-fc'), "only fc/cnn/student models are supported."
    if args.model == 'fc':
    ...
    best_loss = np.inf
    model_path = config.MODEL_PATH.format(file_name=args.model)
